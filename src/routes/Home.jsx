    ...
    <main className="mt-64">
      <section id="main" className="main-section ">
        ...
        <div className="flex items-center p-20 md:px-64">
          ...
          <p className="text-white font-bold sm:p-0 text-[9rem] md:text-[11rem]">
            atheus.<span style={{ color: "#FB3137" }}>dev</span>
          </p>
        </div>
        ...
        >
          <div className={`${!isMobile && "flex flex-column gap-12"}`}>
            ...
            >
              I'm deeply passionate about meticulously crafting visually
          ...
          <div
            className={`comments ${
              isMobile ? "flex gap-5 bottom-20 self-center " : "mt-12"
            }`}
          >
            <p className="text-[2.5rem] font-light md:text-[3.5rem] w-50">
              "Solid problem-solving and code debugging skills to create
